...
namespace ExchangeQuotes.Math.UnitTests
{
    public class AverageCalculatorTest
    {
        ...
        public void GetCurrentResult_SomeNumbers_ActualResult(int[] integers, double expected)
        {
            // Arrange
        ...
        public void GetCurrentResult_SomeNumbersInThread_ActualResult(int[] integers, double expected)
        {
            // Arrange
            AverageCalculator calculator = new();
        ...
        public void GetCurrentResult_SomeNumbersAsyncFill_ActualResult(int[] firstThreadintegers, int[] secondThreadintegers, double expected)
        {
            // Arrange
            AverageCalculator calculator = new();
